...
// Metadata for biomarkers page
export const metadata: Metadata = {
  title: "Biomarkers for Longevity | Longevity Grow",
  description: "Learn about key biomarkers for tracking longevity and health optimization. Understand blood tests, genetic markers, and health metrics.",
  keywords: "biomarkers, longevity, health metrics, blood tests, genetic markers, health optimization, lab tests",
  authors: [{ name: "Longevity Grow" }],
  creator: "Longevity Grow",
  publisher: "Longevity Grow",
  robots: "index, follow",
  alternates: {
    canonical: "https://www.longevitygrow.com/biomarkers",
  },
  openGraph: {
    title: "Biomarkers for Longevity | Longevity Grow",
    description: "Learn about key biomarkers for tracking longevity and health optimization. Understand blood tests, genetic markers, and health metrics.",
    url: "https://www.longevitygrow.com/biomarkers",
...
export default async function BiomarkersPage() {
  ...
  try {
    const { articles: fetchedArticles } = await getArticlesByCategory('biomarkers');
