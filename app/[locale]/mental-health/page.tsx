...
export default function MentalHealthPage() {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        ...
        // Use the category slug 'mental-health'
        const result = await getArticlesByCategory('mental-health', 1, 10, locale);
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-purple-600 to-pink-700 text-white py-32 md:py-40 lg:py-48 overflow-hidden">
        {/* Background image */}
        <div className="absolute inset-0 z-0 opacity-40">
          <Image
            src="/images/categories/sleep.jpg"
            alt="Mental & Cognitive Health"
            fill
            priority
