...
// Metadata for fitness page
export const metadata: Metadata = {
  title: "Fitness for Longevity | Longevity Grow",
  description: "Discover evidence-based fitness strategies that promote longevity and healthy aging. Learn about strength training, cardio, flexibility, and exercise protocols.",
  keywords: "fitness, longevity, exercise, strength training, cardio, healthy aging, physical activity, workout",
  authors: [{ name: "Longevity Grow" }],
  creator: "Longevity Grow",
  publisher: "Longevity Grow",
  robots: "index, follow",
  alternates: {
    canonical: "https://www.longevitygrow.com/fitness",
  },
  openGraph: {
    title: "Fitness for Longevity | Longevity Grow",
    description: "Discover evidence-based fitness strategies that promote longevity and healthy aging.",
    url: "https://www.longevitygrow.com/fitness",
...
export default async function FitnessPage() {
  ...
  try {
    const { articles: fetchedArticles } = await getArticlesByCategory('fitness');
