...
// Metadata for supplements page
export const metadata: Metadata = {
  title: "Supplements for Longevity | Longevity Grow",
  description: "Discover evidence-based supplements that may support longevity and healthy aging. Learn about scientifically proven supplements and their benefits.",
  keywords: "supplements, longevity, anti-aging, vitamins, minerals, nutraceuticals, healthy aging, nutrition",
  authors: [{ name: "Longevity Grow" }],
  creator: "Longevity Grow",
  publisher: "Longevity Grow",
  robots: "index, follow",
  alternates: {
    canonical: "https://www.longevitygrow.com/supplements",
  },
  openGraph: {
    title: "Supplements for Longevity | Longevity Grow",
    description: "Discover evidence-based supplements that may support longevity and healthy aging. Learn about scientifically proven supplements and their benefits.",
    url: "https://www.longevitygrow.com/supplements",
...
export default async function SupplementsPage() {
  ...
  try {
    const { articles: fetchedArticles } = await getArticlesByCategory('supplements');
    articles = fetchedArticles;
  } catch (error) {
    console.error('Error fetching supplements articles:', error);
  }
  return (
    <>
      {/* Hero Section */}
